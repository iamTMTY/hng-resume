...
import WorkIcon from "assets/briefcase-solid.svg"
    ...
    <div className="px-2 w-full">
      <VerticalTimeline>
        <VerticalTimelineElement
          ...
          contentStyle={{ background: 'rgb(98, 156, 255)', color: '#000' }}
          contentArrowStyle={{ borderRight: '7px solid  rgb(33, 150, 243)' }}
          date="Nov 2021 - present"
          iconStyle={{ background: 'rgb(33, 150, 243)', color: '#fff' }}
          icon={<img src={WorkIcon} alt='briefcase' className="w-full p-4 h-auto" />}
        >
